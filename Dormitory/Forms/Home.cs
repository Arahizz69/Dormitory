...
namespace Dormitory.Forms
{
    public partial class Home : Form
    {
        ...
        public Home()
        {
            ...
            AppData.СonnectionСorrect = false;
            AppData.PMenu = panelMenu;
            AppData.BSetings = button2;
        }
        ...
        private void ActivateButton(object btnSender)
        {
            if (btnSender != null)
            {
                if (currentButton != (Button)btnSender)
                {
                    ...
                    ThemeColor.SecondaryLightColor = ThemeColor.ChangeColorBrightness(color, 0.35);
                    ThemeColor.SecondaryColor = ThemeColor.ChangeColorBrightness(color, -0.3);
                    ThemeColor.AdditionalColor = ThemeColor.ChangeColorBrightness(color, -0.35);
        ...
        {
            OpenChildForm(new Parents(), sender);
        }
        ...
        private void Home_Load(object sender, EventArgs e)
        {
            ...
            AppData.modelBD = new Data.ModelBD();
            OpenChildForm(new Authorization(), null);
        }

        private void Button3_Click_1(object sender, EventArgs e)
        {
            Reset();
            AppData.activUsers = null;
            AppData.admin = false;
            AppData.IsAuthoriz = false;
            OpenChildForm(new Authorization(), null);
